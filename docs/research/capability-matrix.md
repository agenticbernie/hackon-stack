...
| Execution | Factory Droid headless adapter | TESTED | `FactoryDroidAdapter`; requires Droid and `OPENAI_API_KEY` |
...
| Skills | 34 skills across strategy, product, design, engineering, quality, DevOps, data, business, and learning | ADOPT | `skills/` |
...
| Autonomous multi-agent E2E | real Factory Droid fixture | MISSING | test is present but live verification is blocked until `OPENAI_API_KEY` is available |
