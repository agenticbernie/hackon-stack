...
async function persistSnapshot(workspace: string, run: Awaited<ReturnType<Orchestrator["run"]>>): Promise<void> {
  const directory = join(process.cwd(), "docs", "e2e", "feature-development");
