---
name: strategy-brief
description: Use the strategy brief method with explicit evidence and a next decision.
---

# Strategy brief

Frame the objective as a decision, not a slogan. Record the target user,
desired outcome, alternatives, constraints, assumptions, evidence, and the
decision owner. End with falsifiable acceptance criteria and a review date.

## Purpose
Use strategy brief to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns strategy brief, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the strategy brief method to classify facts, assumptions, risks, and alternatives.
