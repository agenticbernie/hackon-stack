---
name: learning-influence
description: Use the learning influence method with explicit evidence and a next decision.
---

# Learning influence

Compare consecutive cycles and identify a behavior change caused by prior
learning. Preserve the old and new decision, the retrieval cue, and fresh
evidence. Do not claim compounding unless the later cycle actually differs.

## Purpose
Use learning influence to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns learning influence, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the learning influence method to classify facts, assumptions, risks, and alternatives.
