...
description: Use the user interviews method with explicit evidence and a next decision.
---

# User interviews

Ask about recent behavior, workarounds, costs, and outcomes before asking for
opinions. Preserve exact evidence with consent and provenance. Synthesize
patterns without treating one request as proof of a market.

## Purpose
Use user interviews to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns user interviews, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the user interviews method to classify facts, assumptions, risks, and alternatives.
