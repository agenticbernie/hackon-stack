...
description: Use the market research method with explicit evidence and a next decision.
---

# Market research

Separate observed market evidence from estimates and narratives. Define the
segment, alternatives, buyer, trigger, and source quality. Capture citations,
contradictions, and the decision the research changes.

## Purpose
Use market research to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns market research, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the market research method to classify facts, assumptions, risks, and alternatives.
