---
name: api-design
description: Use the api design method with explicit evidence and a next decision.
---

# API design

Define contracts, validation, errors, idempotency, compatibility, auth,
rate limits, and observability before implementation. Include examples and
consumer-facing migration notes. Treat undocumented behavior as a risk.

## Purpose
Use api design to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns api design, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the api design method to classify facts, assumptions, risks, and alternatives.
