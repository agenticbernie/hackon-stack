...
description: Use the sales discovery method with explicit evidence and a next decision.
---

# Sales discovery

Qualify the customer's problem, urgency, authority, process, alternatives,
budget, and success condition. Preserve evidence and disconfirming signals.
End with a concrete next step or a documented no-fit decision.

## Purpose
Use sales discovery to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns sales discovery, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the sales discovery method to classify facts, assumptions, risks, and alternatives.
