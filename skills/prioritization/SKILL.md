---
name: prioritization
description: Use the prioritization method with explicit evidence and a next decision.
---

# Prioritization

Compare opportunities with an explicit rubric. Show expected value,
confidence, effort, reversibility, and strategic fit. Record rejected options
and the evidence that would change the order.

## Purpose
Use prioritization to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns prioritization, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the prioritization method to classify facts, assumptions, risks, and alternatives.
