...
## Purpose
Use code review to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns code review, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the code review method to classify facts, assumptions, risks, and alternatives.
