---
name: retrospective
description: Use the retrospective method with explicit evidence and a next decision.
---

# Retrospective

Review intended versus observed outcomes, decisions, evidence quality,
surprises, failures, and successful patterns. Assign one or two concrete
changes with owners. Store retrieval cues so later cycles can use the lesson.

## Purpose
Use retrospective to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns retrospective, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the retrospective method to classify facts, assumptions, risks, and alternatives.
