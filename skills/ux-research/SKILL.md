---
name: ux-research
description: Use the ux research method with explicit evidence and a next decision.
---

# UX research

Trace the user journey and identify confusion, accessibility, trust, and
failure points. Use observed behavior where possible. Turn findings into
testable interaction requirements with severity and affected users.

## Purpose
Use ux research to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns ux research, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the ux research method to classify facts, assumptions, risks, and alternatives.
