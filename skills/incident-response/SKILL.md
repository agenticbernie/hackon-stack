...
description: Use the incident response method with explicit evidence and a next decision.
---

# Incident response

Contain safely, preserve evidence, establish a timeline, communicate impact,
and choose reversible remediation. Separate root cause from contributing
conditions. End with owners, deadlines, and a tested prevention action.

## Purpose
Use incident response to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns incident response, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the incident response method to classify facts, assumptions, risks, and alternatives.
