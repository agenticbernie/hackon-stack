...
description: Use the customer success method with explicit evidence and a next decision.
---

# Customer success

Define the customer's desired outcome, onboarding path, adoption signal,
risks, owner, and escalation route. Separate support volume from realized
value and feed recurring failure patterns back into product decisions.

## Purpose
Use customer success to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns customer success, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the customer success method to classify facts, assumptions, risks, and alternatives.
