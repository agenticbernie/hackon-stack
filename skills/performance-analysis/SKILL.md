...
description: Use the performance analysis method with explicit evidence and a next decision.
---

# Performance analysis

Define the workload, baseline, target percentile, resource budget, and
measurement method. Profile before optimizing. Compare a reproducible before
and after result and document trade-offs.

## Purpose
Use performance analysis to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns performance analysis, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the performance analysis method to classify facts, assumptions, risks, and alternatives.
