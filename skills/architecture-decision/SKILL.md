...
description: Use the architecture decision method with explicit evidence and a next decision.
---

# Architecture decision

State the context, forces, options, decision, consequences, and rollback.
Prefer the smallest reversible boundary. Link the decision to evidence and
record what future signal would justify revisiting it.

## Purpose
Use architecture decision to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns architecture decision, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the architecture decision method to classify facts, assumptions, risks, and alternatives.
