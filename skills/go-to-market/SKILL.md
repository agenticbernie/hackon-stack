---
name: go-to-market
description: Use the go-to-market method with explicit evidence and a next decision.
---

# Go-to-market

Choose a narrow segment, problem-led message, channel, proof, activation
path, and owner. Define leading and lagging measures, objections, and a
feedback loop. Avoid claiming distribution from a launch plan alone.

## Purpose
Use go to market to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns go to market, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the go to market method to classify facts, assumptions, risks, and alternatives.
