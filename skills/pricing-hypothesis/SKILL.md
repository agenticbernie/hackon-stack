...
description: Use the pricing hypothesis method with explicit evidence and a next decision.
---

# Pricing hypothesis

Connect price to customer value, willingness to pay, alternatives, cost to
serve, and packaging. Mark estimates as hypotheses. Define a reversible test,
success threshold, and evidence that would change the offer.

## Purpose
Use pricing hypothesis to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns pricing hypothesis, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the pricing hypothesis method to classify facts, assumptions, risks, and alternatives.
