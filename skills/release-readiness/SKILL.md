...
description: Use the release readiness method with explicit evidence and a next decision.
---

# Release readiness

Check functional evidence, security findings, migrations, rollback, support,
observability, and ownership. Classify each gate as verified, conditional, or
unknown. Never convert an unknown into a pass by narrative.

## Purpose
Use release readiness to produce a decision-ready result for the current workflow stage. Keep observations separate from assumptions and recommendations.

## Triggers
Use when the stage objective concerns release readiness, or when a handoff explicitly requests this capability. Do not invoke it for unrelated implementation work.
...
2. Apply the release readiness method to classify facts, assumptions, risks, and alternatives.
